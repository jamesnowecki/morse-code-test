...
const getListOfLetters = morseChar => {
    return translateToText(morseCode, morseChar)
}
const translateToText = (morseObject, morseChar) => {
    return Object.keys(morseObject).find(key => morseObject[key] === morseChar);
}
